...
const Home = () => {
  ...
  return (
    <div>
      <section>
        <div className="col-md-12" style={{ backgroundColor: "#0648a8" ,height: "565px"}}>
          <div className="row">
            <div className="col-md-6">
              <div className="p-5 p-1">
                <h1 className="text-white p-1">Not Getting Job ?</h1>
                <h4 className="text-white">
                  Join Us To Get Interviews With Internship and Training Till
                  You Get The Job{" "}
                </h4>
                <br />
              ...
              <div className="p-5">
                <button
                  type="btn"
                  className="btn btn-css p-3 f-b text-white"
          ...
          <div className="col-md-12">
            <div className="row">
              <div className="col-md-3">
                <a>
                  <img src="./trainer.png" alt="" className="acci-css" />
                  <span className="text-bold f-size"> 100+</span>
                  <br />
              ...
              <div className="col-md-3">
                <div>
                  <a>
                    <img src="./hiring.png" alt="" className="acci-css" />
                    <span className="text-bold f-size">+1500</span>
                    <br />
              ...
              <div className="col-md-3">
                <a>
                  <img src="./alumini.png" alt="" className="acci-css" />
                  <span className="text-bold f-size">5000</span>
                  <br />
          ...
          <div className="col-md-12 ">
            <div className="row">
              <div className="col-md-8">
                ...
                <br />
                <h4 className="f-blue">
                  Why Appteknow Is The Best Training Institute In Bangalore?
                </h4>
                <br />
                <div>
                  <span>
                    <img src="check.png" alt="" className="f-blue acc25-css" />
                    Helped more than 50,000+ students and professionals to start
                    & shift their Career into IT
                  </span>
                  <br />
                  <span>
                    <img src="check.png" alt="" className="f-blue acc25-css" />
              ...
              <div className="col-md-4 p-3">
                <div className="p-3 form-css">
                  <form className="p-3 py-3">
                    ...
                    <select name="mob" id="mobile" className="input-form py-3">
                      <br />
                      <option value="Loc"> +91: </option>
                      <br />
      ...
      <section>
        <div className="container-fluid p-5">
          <div className="p-5 text-center">
            <button type="btn" className="btn btn-css p-3 f-b text-white ">
              FOR PLACED STUDENT LIST
            </button>
          </div>
          ...
          <div className="col-md-12  p-3">
            <div className="row">
              <div className="col-md-2">
                <button className="btn btn-outline b-1" type="btn">
                  Python Tutorial
                </button>
              </div>
              <div className="col-md-2">
        ...
        <div className="container-fluid">
          <div className="col-md-12  p-3">
            <div className="row">
              ...
              <div className="col-md-6">
                {/* <h1 className="f-dgray fw-500 text-center">Top Trending Courses</h1> */}
                <h2 className=" f-dgray fw-500 text-center">
                  Interview Questions
                </h2>
              </div>
              <div className="col-md-3"></div>
